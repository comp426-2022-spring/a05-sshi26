[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=7652722&assignment_repo_type=AssignmentRepo)
# a05 Human Interface
...
```
curl http://localhost:5000/app/flips/coin/
```
...
```
curl http://localhost:5000/app/user/error/
```
...
```json
{"message":"Error test successful. (200)"}
```
